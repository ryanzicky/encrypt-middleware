package com.middleware.encrypt.encrypt;
...
public class EncryptEncodeDecodeService {
	...
	@Value("${encrypt.default.encoder:xxxxx@gmail-encode}")
	...
	public List<String> getDecodeValue(List<String> sources, Predicate<String> filter) {
		...
		queryRequest.setUid("xxxxx@gmail-decode");//解密时传输发起解密请求的用户ID或账号,无用户则传接口名称，用于解密溯源
